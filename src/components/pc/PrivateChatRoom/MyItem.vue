...
<template>
  ...
  <div style="float:left; width:100%; margin-bottom:0.1rem">
    ...
    <div v-if="messageid === 0" style="display:inline-block; font-size:0.6rem;margin-left:0.2rem;max-width:50%;word-wrap:break-word;word-break:break-all;float:inherit;text-align:left">{{messages}}</div>
